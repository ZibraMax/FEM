"""2D Elasticity: Plane Strain using sparse matrix
"""


from typing import Callable, Tuple

from .PlaneStressSparse import Geometry, PlaneStressSparse
...
class PlaneStrainSparse(PlaneStressSparse):
    ...
    def __init__(self, geometry: Geometry, E: Tuple[float, list], v: Tuple[float, list], fx: Callable = lambda x: 0, fy: Callable = lambda x: 0, **kargs) -> None:
        ...
        PlaneStressSparse.__init__(self, geometry, E, v, 1, fx, fy, **kargs)
        self.C11 = []
        self.C12 = []
        self.C66 = []
