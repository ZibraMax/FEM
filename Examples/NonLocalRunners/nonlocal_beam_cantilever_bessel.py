...
for z in Z[::-1]:
    try:
        ...
        filename = f'./VIGA_VOLADIZO_BESSEL/SiBeam_disp_bessel_{L}_{mu}_{z}.json'
        ...
        try:
            sendMailOutlook(mss=f"{filename} ha terminado!",
                            secrests_path='secrets.txt', files=[f'nonlocal_beam_cantilever_bessel_{log_filename}.log'])
