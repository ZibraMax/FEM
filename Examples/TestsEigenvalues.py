...
start = datetime.now()
print(start)
evals_large_sparse, evecs_large_sparse = largest_eigsh(X, k, which='SM')
elapsed = (datetime.now() - start)
...
start = datetime.now()
print(start)
evals_large_sparse, evecs_large_sparse = eigs(X, k, which='SM')
elapsed = (datetime.now() - start)
print("eigs elapsed time: ", elapsed)
print(evals_large)
